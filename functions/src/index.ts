...
export const deleteMyAccount = onCall(
  ...
  async (request): Promise<DeleteMyAccountResult> => {
    ...
    if (managerPlayerNotesSnapshot.exists) {
      await managerPlayerNotesRef.delete();
      deletedDocumentCount += 1;
    }
