...
function getStoredProjectionFields(asset: DraftableAsset | RosterAsset): DraftProjection {
  return {
    ...
    prospectProjectionModelVersion: asset.prospectProjectionModelVersion ?? null,
    prospectEvidenceSnapshotId: asset.prospectEvidenceSnapshotId ?? null,
    prospectEvidenceAsOf: asset.prospectEvidenceAsOf ?? null,
    prospectEvidenceSource: asset.prospectEvidenceSource ?? null,
    prospectEvidenceConfidence: asset.prospectEvidenceConfidence ?? null,
    prospectTranslationConfidence: asset.prospectTranslationConfidence ?? null,
    prospectPriorWeight: asset.prospectPriorWeight ?? null,
    prospectNhlEvidenceWeight: asset.prospectNhlEvidenceWeight ?? null,
    prospectRoleLabel: asset.prospectRoleLabel ?? null,
    prospectRoleConfidence: asset.prospectRoleConfidence ?? null,
    prospectAppearanceProbability: asset.prospectAppearanceProbability ?? null,
    prospectExpectedAppearances: asset.prospectExpectedAppearances ?? null,
    prospectOpportunityAdjustment: asset.prospectOpportunityAdjustment ?? null,
    prospectMissingCategories: asset.prospectMissingCategories ?? null,
    prospectQualityFlags: asset.prospectQualityFlags ?? null,
    prospectEvidenceProvisional: asset.prospectEvidenceProvisional ?? null,
