...
test('S3F remains intact under RC32 without changing Scoring V3 or Projection V11', async () => {
  const [
    runtime,
    productionRuntime,
    scoringRules,
  ...
  assert.match(packageJson.scripts['security:ci'], /verify:batch(?:s3f|d1a|d1a-1|d1b|d1c|c1a|c1b|c1c|c1d|c1e|c1f):core/);
});
