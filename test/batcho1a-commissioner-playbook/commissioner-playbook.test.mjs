...
test('documentation and the permanent roadmap record the bounded commissioner foundation', async () => {
  ...
  assert.match(roadmap, /Version 1\.42\.1/);
  assert.match(roadmap, /O1\.5[\s\S]*?O1A/);
  assert.match(roadmap, /LOG\.62/);
  assert.match(readme, /Release Candidate 51 \/ Operations Batch O1A\.1/);
  ...
  assert.match(runbook, /Release Candidate 51/);
  assert.match(runbook, /Operations Batch O1A\.1/);
