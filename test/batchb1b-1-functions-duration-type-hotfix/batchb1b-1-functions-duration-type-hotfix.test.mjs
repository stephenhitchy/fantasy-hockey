...
test('B1B.1 verification, CI, documentation, and permanent roadmap remain synchronized', () => {
  ...
  assert.match(packageJson.scripts['security:ci'], /verify:batch(?:b1b-1|b1c|s4a|b1d|s3d|s3e|s3e-1|s3e-1-1|s3f|d1a|d1a-1|d1b|d1c|c1a|c1b|c1c|c1d|c1e|c1f|c1g|c1h):core/);
