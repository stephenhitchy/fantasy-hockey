...
test('S3E.1 stays monitor-only and preserves Scoring V3, Projection V11, Shadow, and RC30', async () => {
...
test('S3E.1 verification, runbook, and permanent roadmap stay synchronized', async () => {
  ...
  assert.match(packageJson.scripts['security:ci'], /verify:batch(?:s3e-1-1|s3f|d1a|d1a-1|d1b|d1c|c1a|c1b|c1c|c1d):core/);
