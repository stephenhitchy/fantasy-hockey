...
test('the six-game window remains frozen and server scoring matches the D1H season-safety baseline', async () => {
  ...
  assert.equal(sha256(serverScoring), 'ef11e3aac37def944ea377e9a2e4f88793236972372fdffc2ecfae178097694a');
});
