...
- [`docs/RINKRAT_CODEBASE_GUIDE.md`](docs/RINKRAT_CODEBASE_GUIDE.md) — current architecture, authority boundaries, repository map, workflow traces, and commenting standard.
...
- [`docs/RINKRAT_SCALE_D1N_C_LOAD_PREFLIGHT.md`](docs/RINKRAT_SCALE_D1N_C_LOAD_PREFLIGHT.md) — Production-refusing staged-load entry gate, physical-device prerequisites, fixed 100/500/2,000/5,000 progression, metrics, thresholds, and rollback boundary.
